...
const RegisterApartment = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!apartmentName.trim()) {
      toast({ 
        title: 'Missing apartment name', 
        description: 'Please enter an apartment name',
        variant: 'destructive'
      });
      return;
    }
    ...
    const apartmentCode = generateApartmentCode();

    // Store apartment info temporarily
    sessionStorage.setItem('newApartment', JSON.stringify({
      name: apartmentName,
      code: apartmentCode
    }));
    ...
    // Redirect to admin registration with the generated code
